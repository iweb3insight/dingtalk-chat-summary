...
[![npm version](https://img.shields.io/npm/v/@your-org/applescript-mcp.svg)](https://www.npmjs.com/package/@your-org/applescript-mcp) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
...
<a href="https://glama.ai/mcp/servers/@your-org/applescript-mcp">
  <img width="380" height="200" src="https://glama.ai/mcp/servers/@your-org/applescript-mcp/badge" alt="AppleScript Server MCP server" />
</a>
...
```json
{
  "mcpServers": {
    "applescript_execute": {
      ...
      "args": [
        "--from",
        "git+https://github.com/your-org/applescript-mcp",
...
```
brew install uv
git clone https://github.com/your-org/applescript-mcp.git
```
